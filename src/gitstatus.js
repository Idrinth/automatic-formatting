...
module.exports = {
    ...
    success: function(repo,commit) {
        request(repo, commit, "No changes due to formatting required, you're good.","success");
    },
    failure: function(repo,commit) {
        request(repo, commit, "Code doesn't seem to be formatted correctly, working on it.","failure");
    }
};
